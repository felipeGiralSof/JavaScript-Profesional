...
async function precache() {
  ...
  return cache.addAll(['/', '/index.html', '/assets/index.js', '/assets/MediaPlayer.js', '/assets/index.css', '/assets/BigBuckBunny_512kb.mp4', '/assets/plugins/AutoPlay.js', '/assets/plugins/AutoPause.js']);
}
